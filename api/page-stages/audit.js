// /api/page-stages/audit.js — audit stage entry point.
...
async function runHandler(req, res) {
  ...
  try {
    var run = await pageStage.runStage('audit', {
    ...
    console.error('[page-stages/audit]', e.message);
...
async function acceptHandler(req, res) {
  ...
  try {
    ...
    console.error('[page-stages/audit accept]', e.message);
